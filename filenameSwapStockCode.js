...
const gorselKlasoru = "C:/Users/hamzaa/Desktop/Akçiçek_Oyuncak"
const excelDosyasi = "C:/Users/hamzaa/Desktop/AKCICEK_imaj_raporu.xlsx"
...
fs.readdir(sourceDir, (err, files) => {
  ...
  files.forEach( file => {
    jsonData.forEach(data => {
      const kod = data["Stok Kod"];
      const filenameSplitDot = file.split(".");
        if (filenameSplitDot[0].includes(kod)) {
